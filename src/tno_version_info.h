...
{
    using ::llc::vcst_c;
    stxp ::llc::u3_c    TNO_VERSION_TIME       = 1749276647;
    ...
    stxp ::llc::vcst_c  TNO_VERSION_STRING     = LLC_CXS("202506070610");
    ...
    stxp ::llc::vcst_c  TNO_VERSION_FILENAME   = LLC_CXS("tno.202506070610.bin");
