...
{
    using ::llc::vcst_c;
    stxp ::llc::u3_c    TNO_VERSION_TIME       = 1749534119;
    ...
    stxp ::llc::u0_c    TNO_VERSION_MINUTE     = 41;
    stxp ::llc::vcst_c  TNO_VERSION_STRING     = LLC_CXS("202506100541");
    stxp ::llc::vcst_c  TNO_VERSION_BRANCH     = LLC_CXS("master");
    stxp ::llc::vcst_c  TNO_VERSION_COMMIT     = LLC_CXS("aa841798f609d8c8712bd59a655c2a0bd8fbfe81");
    stxp ::llc::vcst_c  TNO_VERSION_FILENAME   = LLC_CXS("tno.202506100541.bin");
